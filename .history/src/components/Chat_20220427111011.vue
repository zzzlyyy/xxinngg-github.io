...
export default{
  ...
  methods:{
    connect(){
        var socket = new SockJS('http://localhost:8000/ws/ep');
    ...
    onLoad(){
        ...
        this.axios.get("news/chatmsg/list?current="+this.page+"&fromUser="+this.user.username+"&toUser="+this.author.userName)
        .then((response)=>{
